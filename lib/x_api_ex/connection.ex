defmodule XApiEx.Connection do
  @moduledoc """
  Handle Tesla connections for XApiEx.
  ...
  @doc """
  Configure a XApiEx client.

  ### Parameters

  - `options`: an optional keyword list of XApiEx.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:x_api_ex, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - XApiEx 1.0.0 - elixir"
        )
      )
