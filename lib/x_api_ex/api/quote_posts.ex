defmodule XApiEx.Api.QuotePosts do
  @moduledoc """
  API calls for all endpoints tagged `QuotePosts`.
  """
  ...
  @doc """
  Quote Posts by Post ID
  Returns the most recent Posts mentioning a single user specified by the requested user ID.  For full details, see the [API reference](https://docs.x.com/x-api/posts/retrieve-posts-that-quote-a-post) for this endpoint.  [Sign up](https://t.co/signup) for the X API
  ...
  """
  @spec quote_posts_by_post_id(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, XApiEx.Model.ApiError.t()}
          | {:ok, XApiEx.Model.PostsResponse.t()}
          | {:ok, XApiEx.Model.ApiError.t()}
          | {:error, Tesla.Env.t()}
  def quote_posts_by_post_id(connection, id, opts \\ []) do
    optional_params = %{
      :max_results => :query,
      :start_time => :query,
      :end_time => :query,
